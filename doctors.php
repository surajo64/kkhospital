...
<head>
  ...
  <title> Doctors KIRCT Kilimanjaro Hospital </title>
    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="doctors.php">
            <span>
            ...
            <ul class="navbar-nav">
             ...
             <a class="dropdown-item" href="infertility.php"> Infertility</a>
              ...
              <li class="nav-item active">
                <a class="nav-link" href="doctors.php"><span class="sr-only">(current)</span>Doctors</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <h6 class="">
                Consulant Paediatric Cardiologist
              </h6>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/kibiya.png" alt="">
            </div>
            <div class="detail-box">
              <div class="social_box">
                <a href="https://www.facebook.com/babangida.kibiya.5?mibextid=LQQJ4d">
                  <i class="fa fa-facebook" aria-hidden="true"></i>
                </a>
                <a href="https://x.com/bkibiya?s=21&t=lfl7ru75nqryVNd97lMd4Q">
                  <i class="fa fa-twitter" aria-hidden="true"></i>
                </a>
                <a href="https://youtube.com/@BabangidaKibiya-fo6qi?si=48raoX1mgcmEWUeT">
                  <i class="fa fa-youtube" aria-hidden="true"></i>
                </a>
                <a href="https://www.linkedin.com/in/babangida-saleh-ibrahim-973a072b8?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app">
                  <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
                <a href="https://www.instagram.com/dr_kibiya?igsh=MXc1MmVhb2FvNnR5bQ%3D%3D&utm_source=qr">
                  <i class="fa fa-instagram" aria-hidden="true"></i>
                </a>
              </div>
              <h4>
                Dr. Babagida Saleh Ibrahim 
              </h4>
              <h6 class="">
                Medical Officer
              </h6>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/khalifa.png" alt="">
            </div>
            <div class="detail-box">
              <div class="social_box">
                <a href="">
