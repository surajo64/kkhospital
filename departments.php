...
<head>
  ...
  <title> Services KIRCT Kilimanjaro Hospital </title>
    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="departments.php">
            <span>
          ...
          <div class="col-md-6">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  In KIRCT Kilimanjaro Hospital Provides the following out Patient Services: 
                </p>
                <p>
                  <ul align=" left">
                    <li>Cardiology</li>
            ...
            <div class="box ">
              ...
              <div class="detail-box">
                <h5>
                 ...
                 <p>
                  In KIRCT Kilimanjaro Hospital Provides the following Diagnostics Services: 
                </p>
                <p>
         ...
         <div class="col-md-6">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  We provide quality and unique surgical services to our clients in an ambient and friendly environment.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  We Provide Out-Patient and In-Patient Pharmacy Services.
                </p>
              </div>
            </div>
            </div>
