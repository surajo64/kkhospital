    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="manangement.php">
            <span>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
             ...
             <a class="dropdown-item" href="manangement.php"><span class="sr-only">(current)</span> Manangement</a>
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <h6 class="">
               CMD KIRCT Kilimanjaro hospital
              </h6>
            </div>
          </div>
        </div>
...
<div class="row">
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              <div class="social_box">
                <a href="https://web.facebook.com/surajo.umar.35">
                  <i class="fa fa-facebook" aria-hidden="true"></i>
                </a>
                <a href="https://x.com/surajumardanja?t=9TFoeaq3r5vUTAg4Rtd2eg&s=08">
                  <i class="fa fa-twitter" aria-hidden="true"></i>
                </a>
                <a href="http://www.youtube.com/@surajo.umardanja7231">
                  <i class="fa fa-youtube" aria-hidden="true"></i>
                </a>
                <a href="https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile">
                  <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
                <a href="https://www.instagram.com/surajdanja?utm_source=qr&igsh=MXFiMjhzbWxqdTNydQ==">
