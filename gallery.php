...
<head>
  ...
  <title> Gallery KIRCT Kilimanjaro Hospital </title>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
             ...
             <a class="dropdown-item" href="manangement.php"><span class="sr-only">(current)</span> Image Gallery</a>
            </div>
          </div>
              </li>
              <li class="nav-item">
 ...
 <!-- none section -->
  ...
  <section class="doctor_section layout_padding">
    <div class="container">
     ...
     <div class="row" >
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box" >
            ...
            <h5>
                <center>KIRCT Kilimanjaro hospital</center>
              </h5>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/galllery (4).jpg" alt="">
            </div>
             <h5>
                KIRCT Kilimanjaro hospital Reception
              </h5>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/galllery (3).jpg" alt="">
            </div>
             <h5>
                <center>Pharmacy</center>
              </h5>
            </div>
          </div>
     ...
     <div class="row" >
        <div class="col-sm-3 col-lg-4 mx-auto">
          <div class="box" >
            <div class="img-box">
              <img src="images/galllery (5).jpg" alt="">
            </div>
             <h5>
                <center>Ultrasound Machine</center>
              </h5>
          </div>
        </div>
        <div class="col-sm-3 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/galllery (6).jpg" alt="">
            </div>
            <h5>
                <center>Nurse Triage</center>
              </h5>
          </div>
        </div>
        <div class="col-sm-3 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/galllery (7).jpg" alt="">
            </div>
            <h5>
                <center>KIRCT Kilimanjaro hospital</center>
              </h5>
     ...
     <div class="row" >
        <div class="col-sm-3 col-lg-4 mx-auto">
          <div class="box" >
            <div class="img-box">
              <img src="images/galllery (8).jpg" alt="">
            </div>
            <h5>
                <center>Side Laboratory</center>
              </h5>
          </div>
        </div>
        <div class="col-sm-3 col-lg-4 mx-auto">
