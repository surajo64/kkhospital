...
<head>
  ...
  <title> Infertility KIRCT Kilimanjaro Hospital </title>
    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="infertility.php">
            <span>
        ...
        <div class="heading_container heading_center">
          <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  In KIRCT Kilimanjaro Hospital Provides the following Infertility Services: 
                </p>
        </div>
