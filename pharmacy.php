    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="pharmacy.php">
            <span>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
             ...
             <a class="dropdown-item" href="pharmacy.php"><span class="sr-only">(current)</span>Pharmacy</a>
...
<div class="row" >
        <div class="col-sm-6 col-lg-5 mx-auto">
          <div class="box" >
            <div class="img-box">
              <img src="images/galllery (3).jpg" alt="" height="400" width="600">
            </div>
        ...
        <div class="col-sm-6 col-lg-5 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/pharmacy.jpg" alt="" height="400" width="600">
            </div>
