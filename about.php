...
<head>
  ...
  <title> About-Us KIRCT Kilimanjaro Hospital </title>
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      <div class="row">
        <div class="col-md-4 ">
          <div class="img-box">
            <img src="images/kklogo.png" alt="" height="300" width="300">
          </div>
        </div>
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
               To provide advanced medical and surgical services and training with incorporation of technology in a customer-friendly environment
            </p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              To be among the top providers of advanced medical and surgical services and training in Nigeria and Sub-Saharan Africa
            </p>
          </div>
        </div>
      </div>
