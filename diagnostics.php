    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="diagnostics.php">
            <span>
              ...
              <div class="detail-box">
                ...
                <p>
                  ...
                  <ol align=" left">
                    ...
                    <li><b>Laboratory </b>(Chemical Pathology; Hemathology; Microbiology) </li> 
                    <li><b>Cardiac</b> (ECG; Echocardiography; Stress Test )</li>
...
<div class="row" >
        <div class="col-sm-6 col-lg-5 mx-auto">
          <div class="box" >
            <div class="img-box">
              <img src="images/galllery (5).jpg" alt="" height="400" width="600">
            </div>
            <h5>
                <center>Ultrasound</center>
              </h5>
          </div>
        </div>
        <div class="col-sm-6 col-lg-5 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="images/galllery (8).jpg" alt="" height="400" width="600">
            </div>
            <h5>
